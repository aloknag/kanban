...
describe('Column', () => {
  it('renders with column data-testid', () => {
    render(<Column id="todo" title="To Do" />)
  ...
  it('renders task cards with data-testid', () => {
    ...
    render(<Column id="todo" title="To Do" tasks={tasks} />)
